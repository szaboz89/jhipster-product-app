...
import static com.szabodev.jhipster.web.rest.TestUtil.createFormattingConversionService;
...
public class ProductResourceIntTest {
    ...
    public void getAllProductsByReleaseDateIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the productList where releaseDate greater than or equals to DEFAULT_RELEASE_DATE
        defaultProductShouldBeFound("releaseDate.greaterOrEqualThan=" + DEFAULT_RELEASE_DATE);

        // Get all the productList where releaseDate greater than or equals to UPDATED_RELEASE_DATE
        defaultProductShouldNotBeFound("releaseDate.greaterOrEqualThan=" + UPDATED_RELEASE_DATE);
    }
    ...
    public void getAllProductsByReleaseDateIsLessThanSomething() throws Exception {
        ...
        // Get all the productList where releaseDate less than or equals to DEFAULT_RELEASE_DATE
        defaultProductShouldNotBeFound("releaseDate.lessThan=" + DEFAULT_RELEASE_DATE);

        // Get all the productList where releaseDate less than or equals to UPDATED_RELEASE_DATE
